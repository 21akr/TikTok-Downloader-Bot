...
def start(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Report', url="https://github.com/21akr/TikTok-Downloader-Bot/")]]
    ...
    app.send_message(chat_id=message.from_user.id, text=f"Hello there, I am **TikTok Downloader Bot**.\nI can download TikTok video without Watermark.\n\n"
                          "__**Developer :**__ __@alamort1__\n"
                          "__**Donate :**__ __ 8600570433680914__",
                     parse_mode='md',
...
def help(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Repo 🔰', url="https://github.com/21akr/TikTok-Downloader-Bot/")]]
    reply_markup = InlineKeyboardMarkup(kb)
    app.send_message(chat_id=message.from_user.id, text=f"Nigger, I am **TikTok Downloader Bot**.\nI can download any TikTok video from a given link.\n\n"
